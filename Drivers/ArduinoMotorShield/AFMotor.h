...
#define MOTORLATCH sD12
#define MOTORCLK sD4
#define MOTORENABLE sD7
#define MOTORDATA sD8
#define HIGH 	1
#define LOW 	0

#define pinMode(eShortPin, ulPinIO)				\
	do {																\
		xSysCtlPeripheralEnable(xGPIOSPinToPeripheralId(eShortPin));	\
		xGPIOSDirModeSet(eShortPin, ulPinIO);							\
	} while(0)

#define digitalWrite(eShortPin, v) xGPIOSPinWrite(sD8,v)
